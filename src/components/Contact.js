...
class Contact extends React.Component {
    ...
    submit = (event) => {
        axios.post(__dirname, 'build', '/comment', {name: this.state.name, email: this.state.email, comment: this.state.comment}).then(res => {console.log(res); console.log(res.data);});
